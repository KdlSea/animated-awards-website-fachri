      ...
      >
        <div>
          <h1 className="bento-title special-font">
            ...
            {desc && (
              <p
                className="mt-3 max-w-64 text-xs
              md:text-base"
              >
                {desc}
              </p>
      ...
      <section className="bg-black pb-52">
        ...
        >
          <div className="px-5 py-32">
            <p
              className="
                font-circular-web text-lg text-blue-50"
            >
        ...
        mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]"
          ...
          <div
            className="grid h-[135vh] grid-cols-2
          grid-rows-3 gap-7"
          >
            <BentoTilt
            ...
            <BentoTilt
              className="bento-tilt_1 me-14 md:col-span-1
              md:me-0"
            >
              <BentoCard
